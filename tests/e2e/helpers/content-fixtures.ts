...
export function resetContent() {
  ...
  localSql("truncate public.cms_page_route_events, public.cms_page_routes, public.cms_new_page_identity, public.page_revision_blocks, public.promotion_revision_media, public.cms_promotion_identity, public.media_audit_events, public.revision_media_refs, public.media_versions, public.media_assets, public.content_publication_events, public.content_publication_state, public.content_revisions, public.content_documents");
  localSql("insert into public.cms_page_routes(slug,kind) values ('admin','system'),('api','system'),('_next','system'),('cms-media','system'),('robots','system'),('sitemap','system'),('icon','system'),('apple-icon','system'),('favicon','system'),('manifest','system'),('opengraph-image','system'),('twitter-image','system'),('services','static'),('gallery','static'),('about','static'),('contact','static'),('privacy-policy','static'),('accessibility-statement','static'),('data-deletion','static'),('sofa-cleaning','service'),('mattress-cleaning','service'),('carpet-cleaning','service'),('delicate-upholstery-cleaning','service'),('car-upholstery-cleaning','service'),('armchair-chair-cleaning','service'),('air-conditioner-cleaning','service'),('window-cleaning','service')");
