...
export const faqs = [
  {
    question: "כל כמה זמן מומלץ לנקות מזגן?",
    answer:
      "התדירות תלויה בשימוש, בסביבה ובכמות האבק שמצטברת. כדאי לבדוק ולנקות את הפילטרים לפי הוראות היצרן, ולשקול ניקוי מקצועי כשיש לכלוך נראה לעין, ריח לא נעים או לאחר תקופה ממושכת ללא ניקוי.",
  },
  {
    question: "האם ניקוי מזגן עוזר במקרה של ריח לא נעים?",
    answer:
      "ניקוי מקצועי יכול לסייע בהפחתת ריחות שמקורם באבק ובלכלוך שהצטברו ביחידה הפנימית ובפילטרים. אם הריח נשאר לאחר הניקוי, ייתכן שמקורו בתקלה או בגורם אחר שכדאי לבדוק עם טכנאי מזגנים מוסמך.",
  },
  {
    question: "האם אתם מתקנים תקלות במזגן?",
    answer:
      "לא. CleanBrothers מספקים ניקוי מזגנים מקצועי ולא שירות תיקונים. אם המזגן אינו מקרר, מטפטף או מציג תקלה שנשארת לאחר הניקוי, יש לפנות לטכנאי מזגנים מוסמך.",
  },
  {
    question: "מה כולל ניקוי מזגן?",
    answer:
      "השירות מתמקד בניקוי אבק ולכלוך מהפילטרים ומהחלקים הנגישים ביחידה הפנימית, בהתאם לסוג המזגן ולמצבו. לפני העבודה בודקים את הגישה ומתאמים ציפיות לפי תמונה.",
  },
  {
    question: "כמה זמן לוקח ניקוי מזגן?",
    answer:
      "משך העבודה משתנה לפי סוג המזגן, הגישה אליו ורמת הלכלוך. לאחר קבלת תמונה ופרטים בסיסיים נוכל לתת הערכת זמן ומחיר מדויקת יותר לפני ההגעה.",
  },
  {
