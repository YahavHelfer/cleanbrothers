...
const policySections = [
  ...
  {
    title: "פניות דרך Instagram / Meta",
    content:
      "בעת פנייה ל-CleanBrothers דרך Instagram / Meta, אנו עשויים לקבל ולעבד מזהה חשבון או משתמש ב-Instagram, שם תצוגה או שם משתמש כאשר הם נמסרים על ידי Meta, תוכן הודעות, מידע שהמשתמש מוסר מרצונו במהלך השיחה, וכן מידע טכני או נתוני מטא הנדרשים להפעלת חיבור ההודעות, ככל שרלוונטי.",
  },
  {
    title: "למה המידע משמש",
    content:
      "המידע משמש ליצירת קשר, מתן הצעת מחיר, תיאום שירות, טיפול בפנייה ושיפור השירות וחוויית המשתמש. מידע מפניות דרך Instagram / Meta עשוי לשמש גם למענה לפניות, שירות לקוחות, ניהול לקוחות ואנשי קשר, תיעוד היסטוריית שיחות, ניהול פנימי במערכות CRM וניהול שירות, ושיפור תפעול השירות.",
  },
  {
    title: "קוקיז וכלי מדידה",
    content:
      "כלי מדידה ופרסום מנוהלים בהתאם לבחירת המשתמש ומתחילים עם הרשאות אחסון ושימוש בנתוני פרסום במצב דחוי. ניתן לאשר, לדחות או לשנות את הבחירה בכל עת דרך הקישור לניהול העדפות עוגיות בתחתית האתר. שליחת פנייה לקבלת שירות ממשיכה לפעול גם ללא הסכמה לכלי מדידה ופרסום.",
  },
  {
    title: "שמירת מידע",
    content:
  ...
  },
  {
    ...
    content:
      "מידע לא יועבר לצד שלישי אלא אם הדבר נדרש לצורך תפעול השירות, שמירה על זכויות, עמידה בדרישות חוק או שימוש בכלים טכנולוגיים בסיסיים להפעלת האתר. מידע רלוונטי עשוי להיות מעובד באמצעות ספקי תשתית וטכנולוגיה הנדרשים למתן השירות, לרבות Meta וספקי תשתית, אחסון ו-CRM.",
  },
  {
    title: "זכויות המשתמש",
    content:
      "ניתן לפנות אלינו כדי לבקש עיון, תיקון או מחיקה של מידע אישי המוחזק על ידי CleanBrothers, לרבות מידע מפניות דרך Instagram / Meta, באמצעות פרטי הקשר המופיעים במדיניות זו, בכפוף להוראות הדין ולצרכי תפעול סבירים.",
  },
];
      ...
      <div className="section-container">
        <article className="mx-auto max-w-4xl rounded-[1.5rem] border theme-card p-5 sm:rounded-[2rem] sm:p-10">
          ...
          <p className="mt-7 text-sm font-bold theme-muted">
            תאריך עדכון אחרון: 12 בספטמבר 2026
          </p>
        </article>
      </div>
    </section>
