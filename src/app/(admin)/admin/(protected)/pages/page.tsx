...
export default async function PagesPage() {
  ...
  return <section className="grid gap-6" aria-labelledby="pages-title">
    ...
    <p>ניהול עמודי תוכן בתבניות מאושרות. יצירת עמודים וכתובות חדשות אינה זמינה בשלב המקומי.</p>
    <article className="grid gap-4 rounded-3xl border theme-card p-6">
      ...
      <p>סטטוס CMS: {snapshot ? "פיילוט מקומי — האתר הציבורי עדיין סטטי" : "ממתין לייבוא מקומי"}</p>
      {snapshot ? <>
      ...
      </> : <p>העמוד עדיין לא יובא ל־CMS המקומי.</p>}
    </article>
